...
export const RepositoryServiceImpl: RepositoryService = {
...
export const RepositoryServiceLive = Layer.effect(RepositoryServiceTag, Effect.succeed(RepositoryServiceImpl));
