...
describe("repository-service", () => {
  ...
  describe("parseRepoUrlToPath", () => {
    it.effect("parses SSH URL with scp-style syntax", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
    ...
    it.effect("parses SSH URL without .git extension", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .parseRepoUrlToPath("git@github.com:myorg/myrepo")
          .pipe(Effect.provide(testLayer));
    ...
    it.effect("parses GitLab SSH URL", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .parseRepoUrlToPath("git@gitlab.com:mygroup/myproject.git")
          .pipe(Effect.provide(testLayer));
    ...
    it.effect("parses HTTPS URL", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .parseRepoUrlToPath("https://github.com/myorg/myrepo.git")
          .pipe(Effect.provide(testLayer));
    ...
    it.effect("parses HTTPS URL without .git extension", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .parseRepoUrlToPath("https://github.com/myorg/myrepo")
          .pipe(Effect.provide(testLayer));
    ...
    it.effect("parses git+ssh:// URL", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .parseRepoUrlToPath("git+ssh://git@github.com/myorg/myrepo.git")
          .pipe(Effect.provide(testLayer));
    ...
    it.effect("parses ssh:// URL", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .parseRepoUrlToPath("ssh://git@github.com/myorg/myrepo.git")
          .pipe(Effect.provide(testLayer));
    ...
    it.effect("parses URL with custom port", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .parseRepoUrlToPath("ssh://git@github.com:2222/myorg/myrepo.git")
          .pipe(Effect.provide(testLayer));
    ...
    it.effect("handles repositories with hyphens and underscores", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .parseRepoUrlToPath("git@github.com:my-org/my_repo-2.0.git")
          .pipe(Effect.provide(testLayer));
  ...
  describe("expandToFullGitUrl", () => {
    it.effect("returns full URL unchanged", () =>
      Effect.gen(function* () {
        const result = yield* RepositoryLive
          .expandToFullGitUrl("https://github.com/myorg/myrepo", "default-org");
    ...
    it.effect("returns SSH URL unchanged", () =>
      Effect.gen(function* () {
        const result = yield* RepositoryLive
          .expandToFullGitUrl("git@github.com:myorg/myrepo.git", "default-org");
    ...
    it.effect("expands repo name with default org", () =>
      Effect.gen(function* () {
        const result = yield* RepositoryLive
          .expandToFullGitUrl("myrepo", "default-org");
    ...
    it.effect("expands org/repo format", () =>
      Effect.gen(function* () {
        const result = yield* RepositoryLive
          .expandToFullGitUrl("myorg/myrepo", "default-org");
    ...
    it.effect("uses forced GitHub provider", () =>
      Effect.gen(function* () {
        const result = yield* RepositoryLive
          .expandToFullGitUrl("myorg/myrepo", "default-org", undefined, "github");
    ...
    it.effect("uses forced GitLab provider", () =>
      Effect.gen(function* () {
        const result = yield* RepositoryLive
          .expandToFullGitUrl("myorg/myrepo", "default-org", undefined, "gitlab");
    ...
    it.effect("uses org-to-provider mapping for explicit org", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .expandToFullGitUrl("gitlab-org/myrepo", "default-org", orgToProvider);
    ...
    it.effect("uses org-to-provider mapping for default org when no explicit org", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .expandToFullGitUrl("myrepo", "default-org", orgToProvider);
    ...
    it.effect("ignores default org provider mapping when explicit org is provided", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .expandToFullGitUrl("other-org/myrepo", "default-org", orgToProvider);
    ...
    it.effect("force provider overrides org mapping", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .expandToFullGitUrl("myorg/myrepo", "default-org", orgToProvider, "github");
    ...
    it.effect("handles repository names with special characters", () =>
      Effect.gen(function* () {
        const result = yield* RepositoryLive
          .expandToFullGitUrl("my-org/my-repo_2.0", "default-org");
  ...
  describe("edge cases", () => {
    ...
    it.effect("handles http:// protocol URLs", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .parseRepoUrlToPath("http://github.com/myorg/myrepo.git")
          .pipe(Effect.provide(testLayer));
    ...
    it.effect("handles enterprise GitHub URLs", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .parseRepoUrlToPath("git@github.enterprise.com:myorg/myrepo.git")
          .pipe(Effect.provide(testLayer));
    ...
    it.effect("handles deeply nested repository paths", () =>
      Effect.gen(function* () {
        ...
        const result = yield* RepositoryLive
          .parseRepoUrlToPath("https://gitlab.com/group/subgroup/project.git")
          .pipe(Effect.provide(testLayer));
