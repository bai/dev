...
describe("repository-service", () => {
  ...
  describe("parseRepoUrlToPath", () => {
    ...
    it.effect("uses custom base path from WorkspacePaths", () =>
      Effect.gen(function* () {
        const repositoryService = createRepositoryService(makeWorkspacePaths("/custom/projects"));
        const result = yield* repositoryService.parseRepoUrlToPath("git@github.com:myorg/myrepo.git");
    ...
    it.effect("uses factory-injected WorkspacePaths even when a different one exists in context", () =>
      Effect.gen(function* () {
        const repositoryService = createRepositoryService(makeWorkspacePaths());
        const contextWorkspacePaths = makeWorkspacePathsMock("/ctx/projects");
