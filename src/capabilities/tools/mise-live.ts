...
export const makeMiseLive = (shell: Shell, fileSystem: FileSystem, configLoader: ConfigLoader, hostPaths: HostPaths): Mise => ({
...
export const MiseLiveLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return makeMiseLive(shell, fileSystem, configLoader, hostPaths);
  }),
);
