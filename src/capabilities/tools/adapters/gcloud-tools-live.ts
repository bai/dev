...
export const makeGcloudToolsLive = (shell: Shell, filesystem: FileSystem, hostPaths: HostPaths): GcloudTools => {
...
export class GcloudToolsTag extends Effect.Service<GcloudTools>()("GcloudTools", {
  ...
  effect: Effect.gen(function* () {
    ...
    return makeGcloudToolsLive(shell, filesystem, hostPaths);
  }),
}) {}
